...
public class RanksManager {
    ...
    public void loadConfig() {
        ...
        if (config.getConfigurationSection("rank") == null) {
            return;
        }

        for (String name : config.getConfigurationSection("rank").getKeys(false)) {
