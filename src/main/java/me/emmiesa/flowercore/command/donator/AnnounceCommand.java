...
public class AnnounceCommand extends BaseCommand {
    ...
    public void onCommand(CommandArgs args) {
        ...
        format = format.replace("%prefix%", FlowerCore.getInstance().getProfileManager().getRank(playerUUID).getPrefix());
        format = format.replace("%player-display-name%", FlowerCore.getInstance().getProfileManager().getPlayerRankColor(playerUUID));
