...
public class TagRepository {
    ...
    public void loadConfig() {
        FileConfiguration config = plugin.getConfigHandler().getConfig("tags.yml");
    ...
    public void removeTag(String tagName) {
        ...
        FileConfiguration config = FlowerCore.getInstance().getConfigHandler().getConfig("tags.yml");
        File file = FlowerCore.getInstance().getConfigHandler().getConfigFile("tags.yml");
    ...
    public void saveTag(Tag tag) {
        ...
        plugin.getConfigHandler().saveConfig(plugin.getConfigHandler().getConfigFile("tags.yml"), config);
    }
}
