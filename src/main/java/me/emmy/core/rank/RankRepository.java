...
public class RankRepository {
    ...
    public void saveRank(Rank rank) {
        FileConfiguration config = getPlugin().getConfigHandler().getConfig("ranks.yml");
        ...
        getPlugin().getConfigHandler().saveConfig(getPlugin().getConfigHandler().getConfigFile("ranks.yml"), config);
    }
    ...
    public void removeRank(String rankName) {
        ...
        FileConfiguration config = FlowerCore.getInstance().getConfigHandler().getConfig("ranks.yml");
        File file = FlowerCore.getInstance().getConfigHandler().getConfigFile("ranks.yml");
