...
public class TrollSilentCommand extends BaseCommand {
    ...
    public void onCommand(CommandArgs args) {
        ...
        sender.sendMessage(CC.translate(FlowerCore.getInstance().getConfigHandler().getConfig("messages.yml").getString("troll.trolled-silent")).replace("%player%", target.getName()));
    }
}