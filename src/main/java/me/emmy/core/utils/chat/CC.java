...
public class CC {
    ...
    public void listRanks(CommandSender sender) {
        ...
        FileConfiguration ranksConfig = FlowerCore.getInstance().getConfigHandler().getConfig("ranks.yml");
    ...
    public void listTags(CommandSender sender) {
        ...
        FileConfiguration tagsConfig = FlowerCore.getInstance().getConfigHandler().getConfig("tags.yml");
    ...
    public void connect() {
        ...
        Bukkit.getConsoleSender().sendMessage(CC.translate(FlowerCore.getInstance().getPrefix() + "  &f> Host: &f" + FlowerCore.getInstance().getConfigHandler().getConfig("database.yml").getString("database.uri")));
        Bukkit.getConsoleSender().sendMessage(CC.translate(FlowerCore.getInstance().getPrefix() + "  &f> Database: &f" + FlowerCore.getInstance().getConfigHandler().getConfig("database.yml").getString("database.database-name")));
    ...
    public void on(long timeTaken) {
        ...
        Bukkit.getConsoleSender().sendMessage(CC.translate(" "));
        Bukkit.getConsoleSender().sendMessage(CC.translate(" &f| Ranks: &b" + FlowerCore.getInstance().getConfigHandler().getConfig("ranks.yml").getConfigurationSection("ranks").getKeys(false).size()));
        Bukkit.getConsoleSender().sendMessage(CC.translate(" &f| Tags: &b" + FlowerCore.getInstance().getConfigHandler().getConfig("tags.yml").getConfigurationSection("tags").getKeys(false).size()));
        Bukkit.getConsoleSender().sendMessage(CC.translate(" "));
