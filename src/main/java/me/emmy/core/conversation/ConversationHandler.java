package me.emmy.core.conversation;
...
public class ConversationHandler {
    ...
    public void sendMessage(UUID sender, UUID target, String message) {
        ...
        targetPlayer.sendMessage(CC.translate(FlowerCore.getInstance().getConfigHandler().getConfig("messages.yml").getString("private-messages.conversation.from")
        ...
        senderPlayer.sendMessage(CC.translate(FlowerCore.getInstance().getConfigHandler().getConfig("messages.yml").getString("private-messages.conversation.to")
